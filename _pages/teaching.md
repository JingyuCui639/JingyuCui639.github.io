...
- **Teaching Assistant, Statistical Sciences 2141A/B: Applied Probability and Statistics for Engineers**
  - Prepared course materials and led tutorial sessions to reinforce lecture content and support student learning.  
    - [Link for sample tutorial slides](https://docs.google.com/presentation/d/1ST_YSmqgWKVlMXahzQgemNJKbCnzNtQt/edit?usp=sharing&ouid=115624225224620671558&rtpof=true&sd=true)

- **Teaching Assistant, Statistical Sciences 2244A/B: Statistics for Science**
  - Led R programming labs, introducing students to R and teaching basic coding skills for statistical analysis.

- **Teaching Assistant, DS 3000B: Introduction to Machine Learning**
  - Led Python programming labs.

- **Workshop Leader, Introduction to R and Python**
...
- **Accepted by:**
  - Eastern North American Region (ENAR) 2026
  - Society for Epidemiologic Research (SER) 2026
